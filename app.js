...
window.addEventListener('load',()=>{
  ...
  if(_ct === 'email' && _verified === '1' && _em){
    ...
    document.body.insertAdjacentHTML('beforeend', '<div id="connectLoader" style="position:fixed;inset:0;background:#000;display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:9999;overflow:hidden;">'
      ...
      +'<div style="position:absolute;inset:-14px;border-radius:50%;border:2px solid rgba(112,0,255,.35);animation:splashRing 1.8s ease-out infinite;"></div>'
      +'<div style="position:absolute;inset:-28px;border-radius:50%;border:1px solid rgba(112,0,255,.15);animation:splashRing 1.8s ease-out infinite .5s;"></div>'
      +'<div style="width:72px;height:72px;border-radius:22px;background:linear-gradient(135deg,#7000ff,#9333ea);display:flex;align-items:center;justify-content:center;box-shadow:0 0 40px rgba(112,0,255,.6);">'
