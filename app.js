...
window.addEventListener('load',()=>{
  ...
  if(_ct === 'email' && _verified === '1' && _em){
    ...
    document.body.insertAdjacentHTML('beforeend',
      '<div id="connectLoader" style="position:fixed;inset:0;background:'+_bg+';display:flex;flex-direction:column;align-items:center;justify-content:center;z-index:9999;overflow:hidden;">'      +'<div style="margin-bottom:20px;display:flex;align-items:center;gap:10px;">'      +(_isLight ? '<svg width=\"160\" height=\"50\" viewBox=\"0 0 160 50\" fill=\"none\"><path d=\"M20,25 C20,11 4,11 4,25 C4,39 20,39 28,25 C36,11 52,11 52,25 C52,39 36,39 28,25 Z\" fill=\"none\" stroke=\"#7000ff\" stroke-width=\"6\" stroke-linecap=\"round\" stroke-linejoin=\"round\"/><polyline points=\"68,44 68,6 88,44 88,6\" fill=\"none\" stroke=\"#7000ff\" stroke-width=\"5.5\" stroke-linecap=\"square\" stroke-linejoin=\"miter\"/><polyline points=\"96,44 108,6 120,44\" fill=\"none\" stroke=\"#7000ff\" stroke-width=\"5.5\" stroke-linecap=\"square\" stroke-linejoin=\"miter\"/><line x1=\"101\" y1=\"29\" x2=\"115\" y2=\"29\" stroke=\"#7000ff\" stroke-width=\"5.5\" stroke-linecap=\"square\"/><polyline points=\"128,44 128,6 148,44 148,6\" fill=\"none\" stroke=\"#7000ff\" stroke-width=\"5.5\" stroke-linecap=\"square\" stroke-linejoin=\"miter\"/></svg>' : '<svg width=\"160\" height=\"50\" viewBox=\"0 0 160 50\" fill=\"none\"><path d=\"M20,25 C20,11 4,11 4,25 C4,39 20,39 28,25 C36,11 52,11 52,25 C52,39 36,39 28,25 Z\" fill=\"none\" stroke=\"#7000ff\" stroke-width=\"6\" stroke-linecap=\"round\" stroke-linejoin=\"round\"/><polyline points=\"68,44 68,6 88,44 88,6\" fill=\"none\" stroke=\"#7000ff\" stroke-width=\"5.5\" stroke-linecap=\"square\" stroke-linejoin=\"miter\"/><polyline points=\"96,44 108,6 120,44\" fill=\"none\" stroke=\"#7000ff\" stroke-width=\"5.5\" stroke-linecap=\"square\" stroke-linejoin=\"miter\"/><line x1=\"101\" y1=\"29\" x2=\"115\" y2=\"29\" stroke=\"#7000ff\" stroke-width=\"5.5\" stroke-linecap=\"square\"/><polyline points=\"128,44 128,6 148,44 148,6\" fill=\"none\" stroke=\"#7000ff\" stroke-width=\"5.5\" stroke-linecap=\"square\" stroke-linejoin=\"miter\"/></svg>')      +'</div>'      +'<div style="font-size:1rem;font-weight:600;color:'+_txt2+';margin-bottom:6px;">Connecting wallet…</div>'      +'<div style="font-size:.825rem;color:'+_txt3+';margin-bottom:28px;">Check your wallet for a request</div>'      +'<div style="display:flex;gap:7px;margin-bottom:32px;">'      +'<div style="width:8px;height:8px;border-radius:50%;background:#7000ff;animation:dotBounce 1.2s ease-in-out infinite;"></div>'      +'<div style="width:8px;height:8px;border-radius:50%;background:#9333ea;animation:dotBounce 1.2s ease-in-out infinite .2s;"></div>'      +'<div style="width:8px;height:8px;border-radius:50%;background:#c084fc;animation:dotBounce 1.2s ease-in-out infinite .4s;"></div>'      +'</div>'      +'<button onclick="window.location.href=\'/\'" style="background:none;border:1px solid '+_btn+';border-radius:10px;color:'+_txt3+';padding:9px 20px;font-size:.8rem;cursor:pointer;font-family:Inter,sans-serif;">← Go back</button>'      +'<style>@keyframes dotBounce{0%,100%{transform:translateY(0);opacity:.3;}50%{transform:translateY(-10px);opacity:1;}}</style>'      +'</div>');
    setTimeout(async function(){
      try{
